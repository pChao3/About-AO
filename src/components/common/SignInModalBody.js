                ...
                return (
                  <div id={'slide' + (k + 1)} key={k} className="carousel-item relative w-full">
                    ...
                    <div className="  absolute flex justify-between transform -translate-y-1/2 left-5 right-5 bottom-0 ">
                      <a href={`#slide${k != 0 ? k : 5}`} className="btn btn-circle btn-ghost">
                        ❮
                      </a>
                      <h3 className="text-sm mt-4">{img.title} </h3>
                      <a href={`#slide${k == 4 ? 1 : k + 2}`} className="btn btn-circle btn-ghost">
                        ❯
                      </a>
                    </div>
                  </div>
              ...
              {!isOtpSent && (
                <div className={`form-control w-full mt-8`}>
                  <label className="label">
                    <span className={'label-text text-base-content text-xs text-slate-600 '}>
                      {'Enter your email Id'}
                    </span>
                  </label>
                  <input
